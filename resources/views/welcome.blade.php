...
<body class="min-h-screen bg-slate-50 flex flex-col">
    ...
    <header class="w-full bg-green-900 text-white">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            @if (Route::has('login'))
                <nav class="flex gap-4">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-4 py-2 bg-green-700 hover:bg-green-600 rounded text-sm">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="px-4 py-2 hover:underline text-sm">
                            Login
                        </a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="px-4 py-2 border border-green-400 rounded text-sm hover:bg-green-800">
                                Register
                            </a>
                        @endif
                    @endauth
    ...
    <main class="flex-1 flex items-center justify-center px-6">
        <div class="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div>
                ...
                <p class="text-slate-600 mb-6 leading-relaxed">
                    Sistem ini digunakan untuk mengelola alokasi ruang, karyawan, tamu,
                    serta sumber daya operasional perusahaan kehutanan secara terpusat
                    dan terkontrol.
                </p>

                @guest
                    <a href="{{ route('login') }}"
                        class="inline-block bg-green-700 hover:bg-green-600 text-white px-6 py-3 rounded font-medium">
                        Masuk ke Sistem
                    </a>
                @else
            ...
            <div class="hidden md:block">
                <div class="bg-white rounded-lg shadow p-6">
                    <ul class="space-y-4 text-slate-700 text-sm">
                        <li>✔ Manajemen Ruangan & Alokasi</li>
                        <li>✔ Pengelolaan Karyawan & Tamu</li>
    ...
    <footer class="bg-slate-100 text-center text-sm text-slate-500 py-4">
        © {{ date('Y') }} ITCI Hutani Manunggal. All rights reserved.
    </footer>
